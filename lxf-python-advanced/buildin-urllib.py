...
# the encoding error doesnt come from python, but from the encoding that the console is using. 
# So the way to fix it is to run the command (in windows):
# chcp 65001
...
# run chcp 65001 first in the console
